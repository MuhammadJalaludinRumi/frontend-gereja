...
const { orgLicenses, fetchById, update } = useOrganizationLicenses()
...
// Fetch licenses, organizations, dan data by id
const fetchData = async () => {
  ...
  try {
    ...
    if (!data) throw new Error('Data organization license tidak ditemukan.')
...
<template>
  <div class="p-6 w-full overflow-hidden" style="background: var(--ui-bg); color: var(--ui-text);">
    ...
    <div v-if="loading" class="mb-4 text-sm text-gray-400">Memuat data...</div>
