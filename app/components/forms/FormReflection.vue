...
const emit = defineEmits<{
  (e: 'update:modelValue', value: ReflectionForm): void,
  (e: 'submit'): void
  (e: 'cancel'): void
}>()
...
<template>
  <form @submit.prevent="submit" class="space-y-5">
    ...
    <div>
      <label class="block mb-1 font-medium text-sm">
        Judul Renungan <Mandatory/>
      </label>
      <UInput v-model="form.title" class="w-full" placeholder="Masukkan judul renungan" required />
    </div>
